...
public class DiningTitlesFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        View detailsFrame = getActivity().findViewById(R.id.dining_details);
    ...
    void showDetails(int index) {
        ...
        if (mDualPane) {
            ...
            // details data
            DiningDetailsFragment diningDetails = (DiningDetailsFragment)
                    getFragmentManager().findFragmentById(R.id.dining_details);
            ...
            if (diningDetails == null || diningDetails.getShownIndex() != index) {

                // Make the DetailsFragment and give it the currently selected title index
                diningDetails = DiningDetailsFragment.newInstance(index);
                ...
                ft.replace(R.id.dining_details, diningDetails);
            ...
            intent.setClass(getActivity(), DiningDetailsActivity.class);
