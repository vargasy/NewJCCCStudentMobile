...
public class WellnessDetailsFragment extends Fragment {
    ...
    public static WellnessDetailsFragment newInstance(int index) {
        WellnessDetailsFragment f = new WellnessDetailsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       //TextView text = new TextView(getActivity());
        ...
        String url = WellnessInfo.DETAILS[getShownIndex()];
