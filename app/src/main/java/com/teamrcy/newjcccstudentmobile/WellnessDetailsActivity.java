...
public class WellnessDetailsActivity extends ActionBarActivity{
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Wellnesss");
        ...
        WellnessDetailsFragment wellness_details = new WellnessDetailsFragment();

        // Get the Bundle of key-value pairs and assign them to the DetailsFragment
        wellness_details.setArguments(getIntent().getExtras());

        // Add the Details Fragment
        getFragmentManager().beginTransaction().add(android.R.id.content,
                wellness_details).commit();
        mDialog.dismiss();
        }
       }
     }
