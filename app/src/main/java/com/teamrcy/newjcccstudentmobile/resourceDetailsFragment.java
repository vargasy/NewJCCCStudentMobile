...
public class resourceDetailsFragment extends Fragment {
    ...
    public static resourceDetailsFragment newInstance(int index) {
        resourceDetailsFragment f = new resourceDetailsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       //TextView text = new TextView(getActivity());
        ...
        String url = resourceInfo.DETAILS[getShownIndex()];
