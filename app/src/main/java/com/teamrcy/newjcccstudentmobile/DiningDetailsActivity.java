...
public class DiningDetailsActivity extends ActionBarActivity{
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        DiningDetailsFragment dining_details = new DiningDetailsFragment();

        // Get the Bundle of key-value pairs and assign them to the DetailsFragment
        dining_details.setArguments(getIntent().getExtras());

        // Add the Details Fragment
        getFragmentManager().beginTransaction().add(android.R.id.content, dining_details).commit();
        mDialog.dismiss();
        }
       }
}
