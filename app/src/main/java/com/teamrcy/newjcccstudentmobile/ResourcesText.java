...
public class ResourcesText {
    ...
    static String[] Details = {
            ...
            "MAPS\n" + "\n" + "Tickets for the Performing Arts Series are available to JCCC " +
                    "students for just $5 each. Purchase up to two tickets the week of the performance beginning Monday at 10 a.m. — based on availability. Bring your valid JCCC ID to the box office in the Carlsen Center.\n" + "\n" + "The box office is open from 10 a.m. to 5 p.m. Monday through Friday. \n" + "\n" + "For shows and more details, visit the information desk in the Student Center, or visit http://www.jccc.edu/performing-arts-series/events/current/student-tickets.html",

            "OTHER\n" +"\n" +  "The JCCC School yadda, yadda\n" + "\n" + "LOCATION: \n"+
                    "9780 W. 87th St.\n" +
