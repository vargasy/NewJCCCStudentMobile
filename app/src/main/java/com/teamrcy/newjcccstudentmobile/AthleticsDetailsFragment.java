...
public class AthleticsDetailsFragment extends Fragment {

        // Create a DetailsFragment that contains the titles for the correct index
        public static AthleticsDetailsFragment newInstance(int index) {
            AthleticsDetailsFragment f = new AthleticsDetailsFragment();
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            String url = AthleticsInfo.DETAILS[getShownIndex()];
