...
public class EventsTitlesFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> connectArrayToListView = new ArrayAdapter<String>(
                getActivity(),
                android.R.layout.simple_list_item_activated_1, EventsInfo.TITLES);

        // Connect the ListView to the data
        setListAdapter(connectArrayToListView);

        // Check if the FrameLayout with the id details exists
        View detailsFrame = getActivity().findViewById(R.id.Events_details);
    ...
    void showDetails(int index) {
        ...
        if (mDualPane) {
            ...
            // details data
           EventsDetailsFragment EventsDetails = (EventsDetailsFragment)
                    getFragmentManager().findFragmentById(R.id.Events_details);
            ...
            if (EventsDetails == null || EventsDetails.getShownIndex() != index) {

                // Make the DetailsFragment and give it the currently selected title index
                EventsDetails = EventsDetailsFragment.newInstance(index);
                ...
                ft.replace(R.id.Events_details, EventsDetails);
