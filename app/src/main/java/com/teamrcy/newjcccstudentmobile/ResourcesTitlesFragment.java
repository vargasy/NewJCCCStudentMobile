...
public class ResourcesTitlesFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> connectArrayToListView = new ArrayAdapter<String>(
                getActivity(),
                android.R.layout.simple_list_item_activated_1, ResourcesInfo.TITLES);

        // Connect the ListView to the data
        setListAdapter(connectArrayToListView);

        // Check if the FrameLayout with the id details exists
        View detailsFrame = getActivity().findViewById(R.id.resource_details);
    ...
    void showDetails(int index) {
        ...
        if (mDualPane) {
            ...
            // details data
           ResourcesDetailsFragment resourceDetails = (ResourcesDetailsFragment)
                    getFragmentManager().findFragmentById(R.id.resource_details);
            ...
            if (resourceDetails == null || resourceDetails.getShownIndex() != index) {

                // Make the DetailsFragment and give it the currently selected title index
                resourceDetails = ResourcesDetailsFragment.newInstance(index);
                ...
                ft.replace(R.id.resource_details, resourceDetails);
            ...
            intent.setClass(getActivity(), RescourcesDetailsActivity.class);
