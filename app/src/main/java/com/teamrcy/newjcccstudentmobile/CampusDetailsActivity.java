...
public class CampusDetailsActivity extends ActionBarActivity{
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        CampusDetailsFragment campus_details = new CampusDetailsFragment();

        // Get the Bundle of key-value pairs and assign them to the DetailsFragment
        campus_details.setArguments(getIntent().getExtras());

        // Add the Details Fragment
        getFragmentManager().beginTransaction().add(android.R.id.content,
                campus_details).commit();
        mDialog.dismiss();
        }
       }
     }
