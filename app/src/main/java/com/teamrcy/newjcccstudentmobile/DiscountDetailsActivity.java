...
public class DiscountDetailsActivity extends ActionBarActivity{
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        DiscountDetailsFragment discount_details = new DiscountDetailsFragment();

        // Get the Bundle of key-value pairs and assign them to the DetailsFragment
        discount_details.setArguments(getIntent().getExtras());

        // Add the Details Fragment
        getFragmentManager().beginTransaction().add(android.R.id.content,
                discount_details).commit();
        mDialog.dismiss();
        }
       }
     }
