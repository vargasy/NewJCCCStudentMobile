...
public class resourceTitlesFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> connectArrayToListView = new ArrayAdapter<String>(
                getActivity(),
                android.R.layout.simple_list_item_activated_1, resourceInfo.TITLES);
    ...
    void showDetails(int index) {
        ...
        if (mDualPane) {
            ...
            // details data
           resourceDetailsFragment resourceDetails = (resourceDetailsFragment)
            ...
            if (resourceDetails == null || resourceDetails.getShownIndex() != index) {
                ...
                resourceDetails = resourceDetailsFragment.newInstance(index);
            ...
            intent.setClass(getActivity(), resourceDetailsActivity.class);
